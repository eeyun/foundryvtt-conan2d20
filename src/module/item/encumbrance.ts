export class InventoryWeight {
    ...
    get encumbranceFactor() {
        ...
        if (pct < 60 && pct >= 40) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x2`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +1`;
            return encObject;
        }
        if (pct < 80 && pct >= 60) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x3`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +2`;
            return encObject;
        }
         if (pct < 100 && pct >= 80) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x4`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +3`;
            return encObject;
        }
        if (pct < 120 && pct >= 100) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x5`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +4`;
            return encObject;
        }
        if (pct < 140 && pct >= 120) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x6`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +5`;
            return encObject;
        }
        if (pct < 160 && pct >= 140) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x7`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +6`;
            return encObject;
        }
        if (pct >= 160) {
            encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: x8`;
            encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: +7`;
            return encObject;
        }
        encObject.carried = `${game.i18n.localize("CONAN.encumbranceCarriedRatingLabel")}: ${game.i18n.localize("CONAN.encumbranceRatingLessLabel")}`;
        encObject.fatigue = `${game.i18n.localize("CONAN.encumbranceRatingFatigueLabel")}: -`;
        return encObject;
    }
