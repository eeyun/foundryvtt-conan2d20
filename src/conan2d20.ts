...
Hooks.once('setup', () => {
   ...
   (window as any).Conan2d20 = new Conan2d20System();
    ...
    const toLocalize: any = ['attributes', 'skills', 'encumbranceTypes', 'availabilityTypes', 'coverageTypes', 'armorTypes', 'equipmentQualities', 'weaponGroups', 'weaponTypes', 'weaponSizes', 'weaponRanges', 'weaponReaches', 'weaponQualities'];
